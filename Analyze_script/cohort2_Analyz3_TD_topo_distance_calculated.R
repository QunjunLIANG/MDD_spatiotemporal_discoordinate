...
info_dat <- import('output/REST_match_data.xlsx')

dir_tdg <- '/home/lqj/MDD_patient/NIfTI_convert/derivatives/REST/TD_gradient_alignment'
dir_fg <- '/home/lqj/MDD_patient/NIfTI_convert/derivatives/REST/functional_gradient_alignment'
dir_out <- '/home/lqj/MDD_patient/NIfTI_convert/derivatives/REST/SPT_topology'
...
pheatmap(cor_mat_hc, 
         ...
         filename = 'output/REST_hc_spttopo_distance.png',
         width = 12, height = 10)
...
pheatmap(cor_mat_mdd, 
         ...
         filename = 'output/REST_mdd_spttopo_distance.png',
         width = 12, height = 10)
...
pheatmap(cor_mat_gap, 
         ...
         filename = 'output/REST_gap_spttopo_distance.png',
         width = 12, height = 10)
