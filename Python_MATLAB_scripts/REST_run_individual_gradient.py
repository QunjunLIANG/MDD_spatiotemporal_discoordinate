...
all_sbj_file =  '/home/lqj/MDD_patient/R_project/tde_gradient_coupling_in_-mdd/REST_match_data_all.csv' 
...
if grp_con_mat_file is None:
    ...
    file_names = sorted(glob.glob('/home/lqj/MDD_patient/NIfTI_convert/derivatives/REST/power264_timeseries/*_Power264.csv'))
