...
tde_dir     = wkDir + 'derivatives/validation_timeseries_for_TD/time_lag_estimation/' 
outDir       = wkDir + 'derivatives/validation_TDEGradient_alignment/'
sbj_file =  wkDir + 'MDD_validation_dataset.tsv' 
...
if grp_tde_mat_file is None:
    ...
    # define the batch
    batch_size = 6 # 182/7 = 26, means 26 indicidual connectivity would be loaded for each batch
