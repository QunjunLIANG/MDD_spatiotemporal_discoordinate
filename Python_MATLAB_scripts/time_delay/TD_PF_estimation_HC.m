...
%% Setup
% Set parameters
num_nodes      = 4872;    % number of time series, also, number of ROIs`
wkDir          = '/home/lqj/MDD_patient/NIfTI_convert/derivatives/Time_delay_in_voxel/';
...
Yeo_7_path     = [wkDir 'Yeo_7net_roiAnnotation.csv'];
...
for s = useSubject
    ...
    BOLD = load([wkDir subj '_timeseries.mat']); % read in time series matrix
    BOLD = BOLD.data;
