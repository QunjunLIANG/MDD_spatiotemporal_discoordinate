...
wkDir          = '/home/lqj/MDD_patient/NIfTI_convert/derivatives/REST/power264_timeseries/';
outdir         = 'MDD_time_lag_estimation';    % set directory for saving out images here
mkdir([wkDir outdir])
...
sbjNamePath    = '/home/lqj/MDD_patient/R_project/tde_gradient_coupling_in_-mdd/';
subject_list   = importdata([sbjNamePath 'REST_match_data_MDD.tsv']); %!!!!!!!!!!!!!!!!!!!!
...
for s = useSubject
    ...
    BOLD = load([wkDir subj '_Power264.mat']); % read in time series matrix
    BOLD = BOLD.data;
