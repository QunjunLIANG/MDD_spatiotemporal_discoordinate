...
sbj_file     = 'HC_demography_info.tsv' # subject file in BIDS

second_dir   = 'derivatives/fmriprep_HC/xxxx/func/' # xxxx will be replaced by subject name
...
# export timeseries
outDir       = wkDir + 'derivatives/timeseries_for_schaefer400/'
